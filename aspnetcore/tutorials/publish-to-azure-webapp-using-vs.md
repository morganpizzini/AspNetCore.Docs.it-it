...
* <span data-ttu-id="3fbde-201">Modificare la pagina *pages/index. cshtml* Razor e modificarne il contenuto.</span><span class="sxs-lookup"><span data-stu-id="3fbde-201">Edit the *Pages/Index.cshtml* Razor page and change its contents.</span></span> <span data-ttu-id="3fbde-202">Ad esempio, è possibile modificare il paragrafo specificando "Hello ASP.NET Core!":</span><span class="sxs-lookup"><span data-stu-id="3fbde-202">For example, you can modify the paragraph to say "Hello ASP.NET Core!":</span></span>
