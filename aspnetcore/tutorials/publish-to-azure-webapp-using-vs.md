...
Vedere [pubblicare un'app Web nel servizio app Azure usando Visual Studio per Mac](/visualstudio/mac/publish-app-svc?view=vsmac-2019) se si lavora in MacOS.
