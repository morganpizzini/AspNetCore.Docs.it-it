...
1. Sostituire la `scripts` proprietà del file *Package. JSON* con il codice seguente:
...
1. Aggiungere l'istruzione `using` seguente all'inizio del file *Startup.cs* per risolvere il `ChatHub` riferimento:
