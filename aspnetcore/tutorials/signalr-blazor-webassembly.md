---
title: "Usare ASP.NET Core :::no-loc(SignalR)::: con un'app ospitata :::no-loc(Blazor WebAssembly):::"
author: guardrex
...
---
# <a name="use-aspnet-core-no-locsignalr-with-a-hosted-no-locblazor-webassembly-app"></a><span data-ttu-id="6c20a-103">Usare ASP.NET Core :::no-loc(SignalR)::: con un'app ospitata :::no-loc(Blazor WebAssembly):::</span><span class="sxs-lookup"><span data-stu-id="6c20a-103">Use ASP.NET Core :::no-loc(SignalR)::: with a hosted :::no-loc(Blazor WebAssembly)::: app</span></span>
...
<span data-ttu-id="6c20a-105">Questa esercitazione illustra le nozioni di base per la creazione di un'app in tempo reale usando :::no-loc(SignalR)::: con :::no-loc(Blazor WebAssembly)::: .</span><span class="sxs-lookup"><span data-stu-id="6c20a-105">This tutorial teaches the basics of building a real-time app using :::no-loc(SignalR)::: with :::no-loc(Blazor WebAssembly):::.</span></span> <span data-ttu-id="6c20a-106">Si apprenderà come:</span><span class="sxs-lookup"><span data-stu-id="6c20a-106">You learn how to:</span></span>

> [!div class="checklist"]
> * <span data-ttu-id="6c20a-107">Creare un :::no-loc(Blazor WebAssembly)::: progetto di app ospitata</span><span class="sxs-lookup"><span data-stu-id="6c20a-107">Create a :::no-loc(Blazor WebAssembly)::: Hosted app project</span></span>
> * <span data-ttu-id="6c20a-108">Aggiungere la :::no-loc(SignalR)::: libreria client</span><span class="sxs-lookup"><span data-stu-id="6c20a-108">Add the :::no-loc(SignalR)::: client library</span></span>
> * <span data-ttu-id="6c20a-109">Aggiungere un :::no-loc(SignalR)::: Hub</span><span class="sxs-lookup"><span data-stu-id="6c20a-109">Add a :::no-loc(SignalR)::: hub</span></span>
> * <span data-ttu-id="6c20a-110">Aggiungere :::no-loc(SignalR)::: Servizi e un endpoint per l' :::no-loc(SignalR)::: Hub</span><span class="sxs-lookup"><span data-stu-id="6c20a-110">Add :::no-loc(SignalR)::: services and an endpoint for the :::no-loc(SignalR)::: hub</span></span>
> * <span data-ttu-id="6c20a-111">Aggiungi :::no-loc(Razor)::: codice componente per la chat</span><span class="sxs-lookup"><span data-stu-id="6c20a-111">Add :::no-loc(Razor)::: component code for chat</span></span>
...
## <a name="create-a-hosted-no-locblazor-webassembly-app-project"></a><span data-ttu-id="6c20a-127">Creare un progetto di app ospitata :::no-loc(Blazor WebAssembly):::</span><span class="sxs-lookup"><span data-stu-id="6c20a-127">Create a hosted :::no-loc(Blazor WebAssembly)::: app project</span></span>
...
1. <span data-ttu-id="6c20a-133">Selezionare **:::no-loc(Blazor)::: app** e fare clic su **Next (avanti** ).</span><span class="sxs-lookup"><span data-stu-id="6c20a-133">Select **:::no-loc(Blazor)::: App** and select **Next**.</span></span>

1. <span data-ttu-id="6c20a-134">Digitare `:::no-loc(Blazor)::::::no-loc(SignalR):::App` nel campo **nome progetto** .</span><span class="sxs-lookup"><span data-stu-id="6c20a-134">Type `:::no-loc(Blazor)::::::no-loc(SignalR):::App` in the **Project name** field.</span></span> <span data-ttu-id="6c20a-135">Confermare che la voce relativa al **percorso** sia corretta o specificare un percorso per il progetto.</span><span class="sxs-lookup"><span data-stu-id="6c20a-135">Confirm the **Location** entry is correct or provide a location for the project.</span></span> <span data-ttu-id="6c20a-136">Selezionare **Crea**.</span><span class="sxs-lookup"><span data-stu-id="6c20a-136">Select **Create**.</span></span>

1. <span data-ttu-id="6c20a-137">Scegliere il modello di **:::no-loc(Blazor WebAssembly)::: app** .</span><span class="sxs-lookup"><span data-stu-id="6c20a-137">Choose the **:::no-loc(Blazor WebAssembly)::: App** template.</span></span>
...
1. <span data-ttu-id="6c20a-149">Scegliere il modello di **:::no-loc(Blazor WebAssembly)::: app** .</span><span class="sxs-lookup"><span data-stu-id="6c20a-149">Choose the **:::no-loc(Blazor WebAssembly)::: App** template.</span></span> <span data-ttu-id="6c20a-150">Selezionare **Avanti**.</span><span class="sxs-lookup"><span data-stu-id="6c20a-150">Select **Next**.</span></span>
...
1. <span data-ttu-id="6c20a-154">Nel campo **nome progetto** assegnare un nome all'app `:::no-loc(Blazor)::::::no-loc(SignalR):::App` .</span><span class="sxs-lookup"><span data-stu-id="6c20a-154">In the **Project Name** field, name the app `:::no-loc(Blazor)::::::no-loc(SignalR):::App`.</span></span> <span data-ttu-id="6c20a-155">Selezionare **Crea**.</span><span class="sxs-lookup"><span data-stu-id="6c20a-155">Select **Create**.</span></span>
...
## <a name="add-the-no-locsignalr-client-library"></a><span data-ttu-id="6c20a-161">Aggiungere la :::no-loc(SignalR)::: libreria client</span><span class="sxs-lookup"><span data-stu-id="6c20a-161">Add the :::no-loc(SignalR)::: client library</span></span>
...
1. <span data-ttu-id="6c20a-163">In **Esplora soluzioni** fare clic con il pulsante destro del mouse sul `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Client` progetto e scegliere **Gestisci pacchetti NuGet**.</span><span class="sxs-lookup"><span data-stu-id="6c20a-163">In **Solution Explorer** , right-click the `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Client` project and select **Manage NuGet Packages**.</span></span>
...
1. <span data-ttu-id="6c20a-165">Con **Sfoglia** selezionato, digitare `Microsoft.AspNetCore.:::no-loc(SignalR):::.Client` nella casella di ricerca.</span><span class="sxs-lookup"><span data-stu-id="6c20a-165">With **Browse** selected, type `Microsoft.AspNetCore.:::no-loc(SignalR):::.Client` in the search box.</span></span>

1. <span data-ttu-id="6c20a-166">Nei risultati della ricerca selezionare il [`Microsoft.AspNetCore.:::no-loc(SignalR):::.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.:::no-loc(SignalR):::.Client) pacchetto e selezionare **Installa**.</span><span class="sxs-lookup"><span data-stu-id="6c20a-166">In the search results, select the [`Microsoft.AspNetCore.:::no-loc(SignalR):::.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.:::no-loc(SignalR):::.Client) package and select **Install**.</span></span>
...
1. <span data-ttu-id="6c20a-172">Nella barra laterale **soluzione** fare clic con il pulsante destro del mouse sul `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Client` progetto e scegliere **Gestisci pacchetti NuGet**.</span><span class="sxs-lookup"><span data-stu-id="6c20a-172">In the **Solution** sidebar, right-click the `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Client` project and select **Manage NuGet Packages**.</span></span>
...
1. <span data-ttu-id="6c20a-174">Con **Sfoglia** selezionato, digitare `Microsoft.AspNetCore.:::no-loc(SignalR):::.Client` nella casella di ricerca.</span><span class="sxs-lookup"><span data-stu-id="6c20a-174">With **Browse** selected, type `Microsoft.AspNetCore.:::no-loc(SignalR):::.Client` in the search box.</span></span>

1. <span data-ttu-id="6c20a-175">Nei risultati della ricerca selezionare la casella di controllo accanto al [`Microsoft.AspNetCore.:::no-loc(SignalR):::.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.:::no-loc(SignalR):::.Client) pacchetto e selezionare **Aggiungi pacchetto**.</span><span class="sxs-lookup"><span data-stu-id="6c20a-175">In the search results, select the check box next to the [`Microsoft.AspNetCore.:::no-loc(SignalR):::.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.:::no-loc(SignalR):::.Client) package and select **Add Package**.</span></span>
...
## <a name="add-a-no-locsignalr-hub"></a><span data-ttu-id="6c20a-179">Aggiungere un :::no-loc(SignalR)::: Hub</span><span class="sxs-lookup"><span data-stu-id="6c20a-179">Add a :::no-loc(SignalR)::: hub</span></span>

<span data-ttu-id="6c20a-180">Nel `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Server` progetto creare una `Hubs` cartella (plurale) e aggiungere la classe seguente `ChatHub` ( `Hubs/ChatHub.cs` ):</span><span class="sxs-lookup"><span data-stu-id="6c20a-180">In the `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Server` project, create a `Hubs` (plural) folder and add the following `ChatHub` class (`Hubs/ChatHub.cs`):</span></span>
...
## <a name="add-services-and-an-endpoint-for-the-no-locsignalr-hub"></a><span data-ttu-id="6c20a-181">Aggiungere servizi e un endpoint per l' :::no-loc(SignalR)::: Hub</span><span class="sxs-lookup"><span data-stu-id="6c20a-181">Add services and an endpoint for the :::no-loc(SignalR)::: hub</span></span>

1. <span data-ttu-id="6c20a-182">Nel progetto `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Server` aprire il file `Startup.cs`.</span><span class="sxs-lookup"><span data-stu-id="6c20a-182">In the `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Server` project, open the `Startup.cs` file.</span></span>
...
1. <span data-ttu-id="6c20a-184">Aggiungere :::no-loc(SignalR)::: e rispondere ai servizi middleware di compressione per `Startup.ConfigureServices` :</span><span class="sxs-lookup"><span data-stu-id="6c20a-184">Add :::no-loc(SignalR)::: and Response Compression Middleware services to `Startup.ConfigureServices`:</span></span>
...
## <a name="add-no-locrazor-component-code-for-chat"></a><span data-ttu-id="6c20a-188">Aggiungi :::no-loc(Razor)::: codice componente per la chat</span><span class="sxs-lookup"><span data-stu-id="6c20a-188">Add :::no-loc(Razor)::: component code for chat</span></span>

1. <span data-ttu-id="6c20a-189">Nel progetto `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Client` aprire il file `Pages/Index.razor`.</span><span class="sxs-lookup"><span data-stu-id="6c20a-189">In the `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Client` project, open the `Pages/Index.razor` file.</span></span>
...
> [!div class="checklist"]
> * <span data-ttu-id="6c20a-226">Creare un :::no-loc(Blazor WebAssembly)::: progetto di app ospitata</span><span class="sxs-lookup"><span data-stu-id="6c20a-226">Create a :::no-loc(Blazor WebAssembly)::: Hosted app project</span></span>
> * <span data-ttu-id="6c20a-227">Aggiungere la :::no-loc(SignalR)::: libreria client</span><span class="sxs-lookup"><span data-stu-id="6c20a-227">Add the :::no-loc(SignalR)::: client library</span></span>
> * <span data-ttu-id="6c20a-228">Aggiungere un :::no-loc(SignalR)::: Hub</span><span class="sxs-lookup"><span data-stu-id="6c20a-228">Add a :::no-loc(SignalR)::: hub</span></span>
> * <span data-ttu-id="6c20a-229">Aggiungere :::no-loc(SignalR)::: Servizi e un endpoint per l' :::no-loc(SignalR)::: Hub</span><span class="sxs-lookup"><span data-stu-id="6c20a-229">Add :::no-loc(SignalR)::: services and an endpoint for the :::no-loc(SignalR)::: hub</span></span>
> * <span data-ttu-id="6c20a-230">Aggiungi :::no-loc(Razor)::: codice componente per la chat</span><span class="sxs-lookup"><span data-stu-id="6c20a-230">Add :::no-loc(Razor)::: component code for chat</span></span>

<span data-ttu-id="6c20a-231">Per altre informazioni sulla creazione di :::no-loc(Blazor)::: app, vedere la :::no-loc(Blazor)::: documentazione:</span><span class="sxs-lookup"><span data-stu-id="6c20a-231">To learn more about building :::no-loc(Blazor)::: apps, see the :::no-loc(Blazor)::: documentation:</span></span>

> [!div class="nextstepaction"]
> <span data-ttu-id="6c20a-232"><xref:blazor/index>
> [Autenticazione del token di porta con :::no-loc(Identity)::: Server, WebSocket ed eventi di Server-Sent](xref:signalr/authn-and-authz#bearer-token-authentication)</span><span class="sxs-lookup"><span data-stu-id="6c20a-232"><xref:blazor/index>
...
* [<span data-ttu-id="6c20a-234">:::no-loc(SignalR)::: negoziazione tra le origini per l'autenticazione</span><span class="sxs-lookup"><span data-stu-id="6c20a-234">:::no-loc(SignalR)::: cross-origin negotiation for authentication</span></span>](xref:blazor/fundamentals/additional-scenarios#signalr-cross-origin-negotiation-for-authentication)
