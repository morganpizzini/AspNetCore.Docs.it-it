<span data-ttu-id="b54af-101">Aggiungere le proprietà seguenti alla classe `Movie`:</span><span class="sxs-lookup"><span data-stu-id="b54af-101">Add the following properties to the `Movie` class:</span></span>
