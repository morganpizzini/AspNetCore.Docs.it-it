...
Nella configurazione precedente, la fine del valore non `Audience` include l' **not** ambito predefinito `/{DEFAULT SCOPE}` .
...
Nell'esempio precedente, la fine del valore non `Audience` include l' **not** ambito predefinito `/API.Access` .
