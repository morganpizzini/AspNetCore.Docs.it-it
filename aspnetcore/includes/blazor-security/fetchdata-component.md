<span data-ttu-id="cb7ca-101">Il `FetchData` componente Mostra come:</span><span class="sxs-lookup"><span data-stu-id="cb7ca-101">The `FetchData` component shows how to:</span></span>
