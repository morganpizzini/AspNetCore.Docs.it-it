<span data-ttu-id="fd5b5-101">Il `FetchData` componente Mostra come:</span><span class="sxs-lookup"><span data-stu-id="fd5b5-101">The `FetchData` component shows how to:</span></span>
