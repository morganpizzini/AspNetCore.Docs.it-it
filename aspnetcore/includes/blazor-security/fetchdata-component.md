<span data-ttu-id="9d0f7-101">Il `FetchData` componente mostra come:</span><span class="sxs-lookup"><span data-stu-id="9d0f7-101">The `FetchData` component shows how to:</span></span>
