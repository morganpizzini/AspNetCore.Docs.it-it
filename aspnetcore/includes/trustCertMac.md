<span data-ttu-id="400e0-101">Visual Studio per Mac Visualizza il popup seguente:</span><span class="sxs-lookup"><span data-stu-id="400e0-101">Visual Studio for Mac displays the following popup:</span></span>
