<span data-ttu-id="cce76-101">Visual Studio per Mac Visualizza il popup seguente:</span><span class="sxs-lookup"><span data-stu-id="cce76-101">Visual Studio for Mac displays the following popup:</span></span>
