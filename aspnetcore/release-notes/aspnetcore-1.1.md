...
- [Cookieprovider TempData basato su](xref:fundamentals/app-state#tempdata)
...
- [Provider di configurazione Azure Key Vault](xref:security/key-vault-configuration)
