---
title: "Condividi controller, visualizzazioni, :::no-loc(Razor)::: pagine e altro ancora con le parti dell'applicazione in ASP.NET Core"
author: rick-anderson
description: "Condividi controller, Visualizza, :::no-loc(Razor)::: pagine e altro con le parti dell'applicazione in ASP.NET Core"
ms.author: riande
ms.date: 11/11/2019
no-loc:
...
---
# <a name="share-controllers-views-no-locrazor-pages-and-more-with-application-parts"></a><span data-ttu-id="05561-103">Condividi controller, visualizzazioni, :::no-loc(Razor)::: pagine e altro ancora con le parti dell'applicazione</span><span class="sxs-lookup"><span data-stu-id="05561-103">Share controllers, views, :::no-loc(Razor)::: Pages and more with Application Parts</span></span>
...
<span data-ttu-id="05561-126">Utilizzare una [ :::no-loc(Razor)::: libreria di classi](xref:razor-pages/ui-class) per includere viste nell'assembly.</span><span class="sxs-lookup"><span data-stu-id="05561-126">Use a [:::no-loc(Razor)::: class library](xref:razor-pages/ui-class) to include views in the assembly.</span></span>
...
* <span data-ttu-id="05561-137">`Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::`.</span><span class="sxs-lookup"><span data-stu-id="05561-137">`Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::`.</span></span>
...
* <span data-ttu-id="05561-141">`internal class`[ :::no-loc(Razor)::: CompiledItemFeatureProvider](https://github.com/dotnet/AspNetCore/blob/master/src/Mvc/Mvc.:::no-loc(Razor):::/src/ApplicationParts/:::no-loc(Razor):::CompiledItemFeatureProvider.cs#L14)</span><span class="sxs-lookup"><span data-stu-id="05561-141">`internal class` [:::no-loc(Razor):::CompiledItemFeatureProvider](https://github.com/dotnet/AspNetCore/blob/master/src/Mvc/Mvc.:::no-loc(Razor):::/src/ApplicationParts/:::no-loc(Razor):::CompiledItemFeatureProvider.cs#L14)</span></span>
...
<span data-ttu-id="05561-181">Utilizzare una [ :::no-loc(Razor)::: libreria di classi](xref:razor-pages/ui-class) per includere viste nell'assembly.</span><span class="sxs-lookup"><span data-stu-id="05561-181">Use a [:::no-loc(Razor)::: class library](xref:razor-pages/ui-class) to include views in the assembly.</span></span>
...
* <span data-ttu-id="05561-193">`Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::`.</span><span class="sxs-lookup"><span data-stu-id="05561-193">`Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::`.</span></span>
