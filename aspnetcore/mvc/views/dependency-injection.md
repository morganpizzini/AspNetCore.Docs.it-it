...
<span data-ttu-id="7db52-111">*:::no-loc(appsettings.json):::* i valori possono essere inseriti direttamente in una visualizzazione.</span><span class="sxs-lookup"><span data-stu-id="7db52-111">*:::no-loc(appsettings.json):::* values can be injected directly into a view.</span></span>

<span data-ttu-id="7db52-112">Esempio di un *:::no-loc(appsettings.json):::* file:</span><span class="sxs-lookup"><span data-stu-id="7db52-112">Example of an *:::no-loc(appsettings.json):::* file:</span></span>
