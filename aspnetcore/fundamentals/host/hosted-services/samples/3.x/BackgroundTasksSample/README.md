# <a name="aspnet-core-background-tasks-sample"></a>Esempio ASP.NET di attività in background di base
...
Eseguire l'esempio da una shell dei comandi:Run the sample from a command shell:
