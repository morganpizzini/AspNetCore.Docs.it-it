...
---
# <a name="set-up-a-redis-backplane-for-aspnet-core-signalr-scale-out"></a>Configurare un backplane Redis per la SignalR scalabilità orizzontale di ASP.NET Core
