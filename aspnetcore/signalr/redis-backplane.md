...
* Distribuire un server Redis.
  ...
  * [Documentazione di Cache Redis di Azure](/azure/redis-cache/)
...
SignalR non memorizza nel buffer i messaggi per inviarli quando viene restituito il server. Tutti i messaggi inviati durante il server Redis vengono persi.
