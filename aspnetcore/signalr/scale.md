...
![Ridimensionamento SignalR senza backplane](scale/_static/scale-no-backplane.png)
...
![Stabilire una connessione al servizio di Azure SignalR](scale/_static/azure-signalr-service-one-connection.png)
