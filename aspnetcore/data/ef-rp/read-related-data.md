---
title: 'Parte 6, :::no-loc(Razor)::: pagine con EF core nei dati correlati alla lettura ASP.NET Core'
author: rick-anderson
description: 'Parte 6 di :::no-loc(Razor)::: pagine e Entity Framework serie di esercitazioni.'
ms.author: riande
ms.custom: mvc
ms.date: 09/28/2019
no-loc:
...
---
# <a name="part-6-no-locrazor-pages-with-ef-core-in-aspnet-core---read-related-data"></a><span data-ttu-id="05d1b-103">Parte 6, :::no-loc(Razor)::: pagine con EF core nei dati correlati alla lettura ASP.NET Core</span><span class="sxs-lookup"><span data-stu-id="05d1b-103">Part 6, :::no-loc(Razor)::: Pages with EF Core in ASP.NET Core - Read Related Data</span></span>
...
<span data-ttu-id="05d1b-442">Aggiungere il markup seguente alla fine della pagina *pages/Instructors/index. cshtml* :::no-loc(Razor)::: :</span><span class="sxs-lookup"><span data-stu-id="05d1b-442">Add the following markup to the end of the *Pages/Instructors/Index.cshtml* :::no-loc(Razor)::: Page:</span></span>
