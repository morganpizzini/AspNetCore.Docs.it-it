---
title: 'Parte 4, :::no-loc(Razor)::: pagine con EF Core nelle migrazioni ASP.NET Core'
author: rick-anderson
description: 'Parte 4 di :::no-loc(Razor)::: pagine e Entity Framework serie di esercitazioni.'
ms.author: riande
ms.date: 07/22/2019
no-loc:
...
---
# <a name="part-4-no-locrazor-pages-with-ef-core-migrations-in-aspnet-core"></a><span data-ttu-id="91492-103">Parte 4, :::no-loc(Razor)::: pagine con migrazioni di EF core in ASP.NET Core</span><span class="sxs-lookup"><span data-stu-id="91492-103">Part 4, :::no-loc(Razor)::: Pages with EF Core migrations in ASP.NET Core</span></span>
