...
>
> La possibilità di impostare `PreferExactMatches` su `@false` o lasciarla non annullata, per impostazione predefinita l'opzione su `false` in C#, *viene fornita solo per compatibilità con le versioni precedenti*.
>
