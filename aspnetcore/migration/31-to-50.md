...
>
> La possibilità di impostare l'opzione su `false` o lasciarla non annullata, per impostazione predefinita l'opzione su `false` , *viene fornita solo per compatibilità con le versioni precedenti*.
>
