...
Se si fa affidamento su un file [Global. JSON](/dotnet/core/tools/global-json) per la destinazione di una specifica versione di .NET Core SDK, aggiornare la `version` proprietà alla versione .NET 5,0 SDK installata. Ad esempio:
