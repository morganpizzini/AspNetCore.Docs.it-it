...
* Razorcompilazione Runtime: il supporto per la compilazione in fase di esecuzione di Razor viste e pagine fa ora parte di [Microsoft. AspNetCore. Mvc. Razor . RuntimeCompilation](https://www.nuget.org/packages/Microsoft.AspNetCore.Mvc.Razor.RuntimeCompilation).
...
### <a name="no-locrazor-class-library"></a>RazorLibreria di classi

RazorI progetti di libreria di classi che forniscono componenti dell'interfaccia utente per MVC devono impostare la `AddRazorSupportForMvc` proprietà nel file di progetto:
...
IdentityAggiornamenti dell'interfaccia utente per ASP.NET Core 3,0:
