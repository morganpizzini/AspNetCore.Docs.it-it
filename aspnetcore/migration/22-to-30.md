...
In ASP.NET Core 3,0 ASP.NET Core MVC rimuove il `Async` suffisso dai nomi delle azioni del controller. Questo nuovo valore predefinito è influenzato dalla generazione del routing e del collegamento. Esempio:
...
* Generazione del collegamento richiesta specifica del `Async` suffisso. Esempio:
...
* Per la generazione di collegamenti non è necessario specificare il `Async` suffisso. Esempio:
