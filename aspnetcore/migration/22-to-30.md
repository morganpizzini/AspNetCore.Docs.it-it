...
![righe eliminate e modificate in un' Razor app Web ASP.NET Core 2,2](22-to-30/_static/startup2.2.png)
...
![righe aggiunte e modificate in un' Razor app Web ASP.NET Core 3,0](22-to-30/_static/startup3.0.png)
...
### <a name="razor-class-library"></a>RazorLibreria di classi
...
### <a name="use-newtonsoftjson-in-an-aspnet-core-30-signalr-project"></a>Usare Newtonsoft.Jsin un progetto ASP.NET Core 3,0 SignalR
...
Come illustrato nella documentazione relativa alle [differenze rispetto alle versioni precedenti del routing](xref:fundamentals/routing#differences-from-earlier-versions-of-routing), esistono alcune differenze nella generazione dei collegamenti ( `Url.Link` ad esempio, usando e API simili). incluse le seguenti:
...
## <a name="identity-ui"></a>Interfaccia utente di Identity
