...
### <a name="use-newtonsoftjson-in-an-aspnet-core-30-opno-locsignalr-project"></a>Usare Newtonsoft. JSON in un progetto ASP.NET Core SignalR 3,0
...
* Le app che non usano Razor Pages devono `MapRazorPages`chiamare. Vedere [Razor Pages](#razor-pages) in questo documento.
...
Per ulteriori informazioni sulla compilazione di file Razor, <xref:mvc/views/view-compilation>vedere.
