...
---
# <a name="aspnet-core-21-razor-pages-samesite-cookie-sample"></a>Esempio di Razor cookie navigava sullostesso sito per le pagine di ASP.NET Core 2,1
...
Nel codice precedente, sia l'autenticazione dei cookie che lo stato della sessione impostano il relativo attributo navigava sullostesso sito su `None`, `None` creando l'attributo con un valore e impostando `true`anche l'attributo Secure su.
