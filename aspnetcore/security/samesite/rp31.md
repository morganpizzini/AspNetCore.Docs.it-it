...
---
# <a name="aspnet-core-31-razor-pages-samesite-cookie-sample"></a>Esempio di cookie navigava sullostesso sito per le pagine di ASP.NET Core 3,1 Razor
...
Nel codice illustrato sopra sia l'autenticazione dei cookie che lo stato della sessione impostano il relativo attributo navigava sullostesso sito su None, generando l'attributo con un `None` valore e impostando anche l'attributo Secure su true.
