...
Se l'app è un' Blazor Server app che si basa su SignalR WebSocket, vedere <xref:blazor/host-and-deploy/server#linux-with-nginx> per informazioni su come impostare l' `Connection` intestazione.
