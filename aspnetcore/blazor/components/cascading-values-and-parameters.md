...
---
# <a name="aspnet-core-no-locblazor-cascading-values-and-parameters"></a><span data-ttu-id="c43b5-103">:::no-loc(Blazor):::Parametri e valori di propagazione ASP.NET Core</span><span class="sxs-lookup"><span data-stu-id="c43b5-103">ASP.NET Core :::no-loc(Blazor)::: cascading values and parameters</span></span>
