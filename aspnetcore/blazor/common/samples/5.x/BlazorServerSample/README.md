# <a name="blazor-server-sample-app"></a><span data-ttu-id="1445c-101">App di esempio del server Blazer</span><span class="sxs-lookup"><span data-stu-id="1445c-101">Blazor Server Sample App</span></span>
